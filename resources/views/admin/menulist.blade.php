                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                @foreach($menus as $key)
                                    <tr>
                                        ...
                                        <td>
                                           <i class="fa fa-pencil-alt edit_menu"
                                           data-bs-toggle="modal"
                                           data-bs-target="#editmenumodal"
                                           data-id="{{ $key->id }}"
                                           data-title="{{ $key->title }}"
                                           data-description="{{ $key->description }}"
                                           data-assigned_name="{{ $key->assigned_name }}"
...
<script>
    $(document).ready(function () {
        $(document).on('click', '.edit_menu', function () {
            ...
            $('#menu_title').val($(this).data('title'));
            $('#menu_description').val($(this).data('description'));
            $('#assigned_name').val($(this).data('assigned_name'));
        });
    });
</script>
